				...
				<Card isInteractive={true}>
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<span className="text-muted-foreground text-xs font-bold tracking-wider uppercase">Saldo (Finanse)</span>
						</div>
					...
					<div className="mt-4">
						<p className="text-foreground font-mono text-3xl font-bold tracking-tight tabular-nums">
							14 500,00 <span className="text-muted-foreground text-lg">zł</span>
						</p>
						<p className="mt-1 flex items-center gap-1.5 text-sm font-medium text-emerald-500">
							+4,2% <span className="text-muted-foreground font-normal">w tym miesiącu</span>
						</p>
					</div>
