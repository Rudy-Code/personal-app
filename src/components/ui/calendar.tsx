	...
	return (
		<DayPicker
			...
			classNames={{
				...
				range_start: cn(
					'relative isolate z-0 rounded-l-(--cell-radius) bg-primary after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-secondary',
					defaultClassNames.range_start
				),
				range_middle: cn('rounded-none bg-secondary', defaultClassNames.range_middle),
				range_end: cn(
					'relative isolate z-0 rounded-r-(--cell-radius) bg-primary after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-secondary',
